...
public class SearchPage extends TestBase {
	...
	{
		TestUtil.wait(45, depResults);
		ArrayList<WebElement> totalDep= (ArrayList<WebElement>) driver.findElements(By.xpath("//div[@class='splitVw-sctn pull-left']//div[@class='fli-list splitVw-listing']"));
...
public void getTotalReturnFlights()
	...
	{
		TestUtil.wait(60, retResults);
		ArrayList<WebElement> totalRet= (ArrayList<WebElement>) driver.findElements(By.xpath("//div[@class='splitVw-sctn pull-right']//div[@class='fli-list splitVw-listing']"));
